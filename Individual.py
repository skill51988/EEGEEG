...
ML_Epoch_RC = mne.concatenate_epochs((epochs[0][ML3],  epochs[2][ML1], epochs[4][MR2], epochs[6][ML3]))
MM_Epoch_RC = mne.concatenate_epochs((epochs[0][MM3],  epochs[2][MM1], epochs[4][MM2], epochs[6][MM3]))


ML_Epoch_LC = mne.concatenate_epochs((epochs[1][MR2],epochs[3][ML3],epochs[5][ML1],epochs[7][MR2]))
MM_Epoch_LC = mne.concatenate_epochs((epochs[1][MM2],epochs[3][MM3],epochs[5][MM1],epochs[7][MM2]))
